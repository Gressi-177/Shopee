    ...
    <div className='bg-gray-300/40 py-4 px-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <select className='h-8 px-4 text-center text-sm capitalize bg-white text-black hover:bg-slate-100'>
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-2 flex'>
            <button className='flex h-8 w-9 cursor-not-allowed items-center justify-center rounded-tl-sm rounded-bl-sm bg-white/60  shadow hover:bg-slate-100'>
              <svg
